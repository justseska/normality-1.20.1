...
import net.seska.normality.entity.custom.SapphireFishingBobberEntity;

public class SapphireFishingRodItem extends FishingRodItem {
    public SapphireFishingRodItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (user.fishHook != null) {
            ...
            if (!world.isClient) {
                ...
                Entity testEntity = new SapphireFishingBobberEntity(user, world, j, i);
